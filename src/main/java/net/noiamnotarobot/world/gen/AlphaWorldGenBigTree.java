...
public class AlphaWorldGenBigTree extends AlphaWorldGenerator {
    ...
    void genTreeLayer(int var1, int var2, int var3, float var4) {
        ...
        byte var8 = otherCoordPairs[(byte) 1];
        byte var9 = otherCoordPairs[(byte) 1 + 3];
        ...
        label32:
        for(var11[(byte) 1] = var10[(byte) 1]; var12 <= var7; ++var12) {
            ...
            while(true) {
                while(true) {
                    ...
                    if(var15 > (double)var4) {
                        ...
                        BlockState var14 = this.world.getBlockState(new BlockPos(var11[0], var11[1], var11[2]));
                        if(!var14.isAir() && !var14.isOf(AlphaBlocks.LEAVES)) {
                            ++var13;
                        } else {
                            this.world.setBlockState(new BlockPos(var11[0], var11[1], var11[2]), AlphaBlocks.LEAVES.getDefaultState(), 3);
                            ++var13;
                        }
                    }
                }
    ...
    void generateLeafNode(int var1, int var2, int var3) {
        ...
        for(int var5 = var2 + this.leafDistanceLimit; var4 < var5; ++var4) {
            ...
            this.genTreeLayer(var1, var4, var3, var6);
        }

    }

    void placeTrunkLine(int[] var1, int[] var2) {
        ...
        if(var4[var6] != 0) {
            ...
            for(int var16 = var4[var6] + var9; var15 != var16; var15 += var9) {
                ...
                this.world.setBlockState(new BlockPos(var14[0], var14[1], var14[2]), AlphaBlocks.WOOD.getDefaultState(), 3);
            }
    ...
    int checkBlockLine(int[] var1, int[] var2) {
        ...
        if(var3[var5] == 0) {
            ...
            for(var15 = var3[var5] + var8; var14 != var15; var14 += var8) {
                ...
                if(!var16.isAir() && !var16.isOf(AlphaBlocks.LEAVES)) {
                    break;
                }
            }
    ...
    boolean validTreeLocation() {
        ...
        if(!this.world.getBlockState(new BlockPos(this.basePos[0], this.basePos[1] - 1, this.basePos[2])).isIn(BlockTags.DIRT)) {
            return false;
        } else {
