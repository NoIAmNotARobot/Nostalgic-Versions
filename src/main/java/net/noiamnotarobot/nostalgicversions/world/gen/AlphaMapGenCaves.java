...
public class AlphaMapGenCaves {
    public int range = 8;
    public Random rand = new Random();

    private void generateLargeCaveNode(int var1, int var2, Chunk var3, double var4, double var6, double var8) {
        this.generateCaveNode(var1, var2, var3, var4, var6, var8, 1.0F + this.rand.nextFloat() * 6.0F, 0.0F, 0.0F, -1, -1, 0.5D);
    }

    private void generateCaveNode(int var1, int var2, Chunk var3, double var4, double var6, double var8, float var10, float var11, float var12, int var13, int var14, double var15) {
        ...
        for(boolean var26 = var23.nextInt(6) == 0; var13 < var14; ++var13) {
            ...
            if(var52 || var23.nextInt(4) != 0) {
                ...
                if(var4 >= var17 - 16.0D - var27 * 2.0D && var8 >= var19 - 16.0D - var27 * 2.0D && var4 <= var17 + 16.0D + var27 * 2.0D && var8 <= var19 + 16.0D + var27 * 2.0D) {
                    int var53 = MathHelper.floor(var4 - var27) - var1 * 16 - 1;
                    ...
                    int var55 = MathHelper.floor(var8 - var27) - var2 * 16 - 1;
                    ...
                    for(var40 = var53; !var56 && var40 < var34; ++var40) {
                        for(int var41 = var55; !var56 && var41 < var38; ++var41) {
                            for(int var42 = var36 + 1; !var56 && var42 >= var54 - 1; --var42) {
                                if(var42 < 128) {
                                    if(var3.getBlockState(new BlockPos(var40, var42, var41)).getFluidState().isIn(FluidTags.WATER)) {
                                        var56 = true;
                                    }
                    ...
                    if(!var56) {
                        for(var40 = var53; var40 < var34; ++var40) {
                            ...
                            for(var43 = var55; var43 < var38; ++var43) {
                                ...
                                int var46 = NostalgicVersions.Util.compressBlockPos(new BlockPos(var40, var36, var43));
                                boolean var47 = false;
                                ...
                                for(int var48 = var36 - 1; var48 >= var54; --var48) {
                                    ...
                                    if(var49 > -0.7D && var57 * var57 + var49 * var49 + var44 * var44 < 1.0D) {
                                        ...
                                        BlockState var51 = var3.getBlockState(NostalgicVersions.Util.decompressBlockPos(var46));
                                        if(var51.isOf(AlphaBlocks.GRASS)) {
                                            var47 = true;
                                        }

                                        if(var51.isOf(AlphaBlocks.STONE) || var51.isOf(AlphaBlocks.DIRT) || var51.isOf(AlphaBlocks.GRASS)) {
                                            if(var48 < 10) {
                                                var3.setBlockState(NostalgicVersions.Util.decompressBlockPos(var46), Blocks.LAVA.getDefaultState(), false);
                                            } else {
                                                var3.setBlockState(NostalgicVersions.Util.decompressBlockPos(var46), Blocks.AIR.getDefaultState(), false);
                                                if(var47 && var3.getBlockState(NostalgicVersions.Util.decompressBlockPos(var46 - 1)).isOf(AlphaBlocks.DIRT)) {
                                                    var3.setBlockState(NostalgicVersions.Util.decompressBlockPos(var46 - 1), AlphaBlocks.GRASS.getDefaultState(), false);
                                                }
                                            }
                                        }
                                    }
    ...
    public void recursiveGenerate(Chunk var6, int var2, int var3, int var4, int var5) {
