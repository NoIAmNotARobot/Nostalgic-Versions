...
public class AlphaWorkbenchScreenHandler extends AbstractRecipeScreenHandler<RecipeInputInventory> {
    private final RecipeInputInventory input;
    private final CraftingResultInventory result;
    private final ScreenHandlerContext context;
    private final PlayerEntity player;

    public AlphaWorkbenchScreenHandler(int syncId, PlayerInventory playerInventory) {
        this(syncId, playerInventory, ScreenHandlerContext.EMPTY);
    }

    public AlphaWorkbenchScreenHandler(int syncId, PlayerInventory playerInventory, ScreenHandlerContext context) {
        super(NostalgicVersions.ALPHA_WORKBENCH_SCREEN_HANDLER, syncId);
